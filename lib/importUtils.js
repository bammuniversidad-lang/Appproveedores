...
export const MAPEO_PEDIDOS = {
  ...
  // Variantes defensivas por si el archivo real trae el encabezado
  // ligeramente distinto (sin "de", o como "cumplimiento" en vez de
  // "cumplido") -- esto era la causa más probable de que "Fecha de
  // cumplido" saliera en blanco en el respaldo de Cierre de mes: si el
  // encabezado no calzaba EXACTO con "fechadecumplido", esa columna no
  // se mapeaba y quedaba null para todas las filas de esa carga.
  fechacumplido: 'fecha_cumplido',
  fechadecumplimiento: 'fecha_cumplido',
  fechacumplimiento: 'fecha_cumplido',
  feccumplido: 'fecha_cumplido',
  nroorden: 'nro_orden',
